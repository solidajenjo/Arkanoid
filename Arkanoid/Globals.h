...
#define BALL_TEX_RECT { 46, 94, 5, 5 }    
...
#define PHYSICS_PLAYER_LINEAR_DAMPING 5.9f
#define PLAYER_DENSITY 50.f
#define PLAYER_JOINT_LOCAL_ANCHOR 0.f, -5.f

#define BALL_DENSITY 100.f
#define BALL_RESTITUTION 1.f
#define BALL_SPEED 40.f
#define BALL_VERT_MODIFICATION_ON_PLAYER_HIT 5.f
